...
> Heya! I am Rana Satyam Raj. I am a class 12th student preparing for 
...
class Ranaco():
  ...
  def __init__(self):
    self.name = "Rana Satyam Raj";
    self.username = "Ranaco";
    self.location = "Bihar, India";
    self.twitter = "@ranasatyamraj";
    self.instagram = "@Myself_rana.raj"
